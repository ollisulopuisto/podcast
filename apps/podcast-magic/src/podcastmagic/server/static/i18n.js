...
const STRINGS = {
    ...
    'si.sensitivity': 'Herkkyys',
    'si.sensitivityWhy': 'Desibeleitä raidan oman pohjakohinan yli. Kiinteä kynnys tarkoittaisi eri asiaa jokaisella mikillä.',
  ...
  en: {
    ...
    'si.sensitivityWhy': 'Decibels above the track\'s own noise floor. A fixed threshold would mean something different on every microphone.',
