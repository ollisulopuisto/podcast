...
from fcp_subs_whisper import __version__
...
async def transcribe_wyoming(input_path, uri, _language=None):
...
async def main():
    ...
    if args.diarize:
        ...
        unique_speakers = sorted({s["speaker"] for s in all_segments if "speaker" in s})
        speaker_map = {}
