...
const STRINGS = {
    ...
    'app.render': 'Renderöi video',
    'app.stop': 'Pysäytä',
    'app.stopping': 'Pysäytetään…',
    'app.renderStopped': 'Renderöinti pysäytetty, tiedostoa ei tehty.',
    'app.renderStarting': 'Viedään ja renderöidään…',
    'app.rendering': 'Renderöidään {percent} %',
    'app.rendered': 'Video valmis: {path}',
    'app.renderFailed': 'Renderöinti epäonnistui: {error}',
    'app.tracks': 'Raidat',
    ...
    'app.relink': 'Etsi tiedostot…',
    'app.relinking': 'Etsitään…',
    'app.relinkedCount': 'Linkitetty {n} tiedostoa.',
    'app.relinkNotFound': 'Puuttuvia tiedostoja ei löytynyt.',
    ...
    'vertical.measured': 'Mitattu {files} tiedostoa. Mittaa uudestaan jos roolit muuttuivat.',
    'vertical.needMeasure': 'Kasvoja ei ole mitattu, joten mitään ei rajata. Mittaus kestää minuutteja ja jää välimuistiin.',
    ...
    'patch.groups': 'Ryhmäkuvat',
    'patch.covers': 'Ketkä kuvassa näkyvät',
    'patch.coversAlso': 'Myös kuvassa:',
    'seats.leftToRight': 'Pystyrajaus, istujat vasemmalta oikealle:',
    'seats.hint': 'Klikkaa siirtääksesi vasemmalle',
    'seats.manual': 'järjestys annettu käsin',
    'seats.measured': 'mitattu suun liikkeestä (ero {margin})',
    'seats.reset': 'Palauta mitattu järjestys',
    'patch.groupMics': 'Kuvassa näkyvien mikit',
    'patch.newGroup': '+ ryhmäkuva (kamera, jossa useampi puhuja)',
    ...
    'role.wide': 'Laaja',
    'role.close': 'Lähikuva',
    'role.group': 'Kuva useammasta puhujasta',
    'role.mic': 'Mikki',
  ...
  en: {
    ...
    'app.render': 'Render video',
    'app.stop': 'Stop',
    'app.stopping': 'Stopping…',
    'app.renderStopped': 'Render stopped, no file written.',
    'app.renderStarting': 'Exporting and rendering…',
    'app.rendering': 'Rendering {percent} %',
    'app.rendered': 'Video ready: {path}',
    'app.renderFailed': 'Render failed: {error}',
    'app.tracks': 'Tracks',
    ...
    'app.relink': 'Relink files…',
    'app.relinking': 'Relinking…',
    'app.relinkedCount': 'Relinked {n} file(s).',
    'app.relinkNotFound': 'No missing files found.',
    ...
    'vertical.measured': '{files} files measured. Measure again if the roles changed.',
    'vertical.needMeasure': 'No faces measured, so nothing is framed. Measuring takes minutes and is cached.',
    ...
    'patch.shared': 'Shared',
    'patch.groups': 'Group shots',
    'patch.covers': 'Who is in the shot',
    'patch.coversAlso': 'Also in the shot:',
    'seats.leftToRight': 'Vertical framing, seated left to right:',
    'seats.hint': 'Click to move left',
    'seats.manual': 'order set by hand',
    'seats.measured': 'measured from mouth movement (margin {margin})',
    'seats.reset': 'Use the measured order',
    'patch.groupMics': 'Mics of the people in the shot',
    'patch.newGroup': '+ group shot (a camera showing several speakers)',
    ...
    'role.wide': 'Wide',
    'role.close': 'Close-up',
    'role.group': 'Shot of several speakers',
    'role.mic': 'Microphone',
