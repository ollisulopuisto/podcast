...
Hindenburgin istunnon sanastolle, jolla `speechmix` puhuu, jotta ketjun
tuominen tänne omaksi moduulikseen on ketjun tuomista eikä lukijan
...
from speechmix.timeline import Span as SpeechmixSpan
from speechmix.timeline import Track as SpeechmixTrack
...
class Track:
    ...
    def to_speechmix(self) -> SpeechmixTrack:
        """Convert to speechmix timeline Track."""
        return SpeechmixTrack(
            path=self.path,
            speaker=self.speaker,
            spans=[
                SpeechmixSpan(
                    programme_start=s.programme_start,
                    programme_end=s.programme_end,
